  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#fdf7f4]">
      ...
      <div className="flex flex-col md:flex-row items-stretch relative z-10">
        ...
        <div className="w-full md:w-1/2 bg-white/40 backdrop-blur-xl 
                        px-8 md:px-16 py-16 
          ...
          <div className="max-w-xl relative z-20">
            ...
            <p className="mt-8 leading-relaxed text-[16px] text-[#5b4640] opacity-90">
              ...
              handcrafted personalized chocolate gifting according to the customers needs.
              We manufacture artisan chocolates, cookies, gifting hampers & celebration cakes.
            </p>

            <p className="mt-6 leading-relaxed text-[16px] text-[#5b4640] opacity-90">
              We offer various flavors, shapes, and combinations for all special occasions,
              made with pure ingredients and crafted with love & perfection.
            </p>
