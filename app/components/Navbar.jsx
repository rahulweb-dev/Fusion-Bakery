        ...
        <div className='bg-white shadow-lg border border-gray-200 rounded-full backdrop-blur-md flex items-center w-full max-w-[1400px] py-3 px-5 md:px-8 lg:px-10'>
          ...
          <div className='hidden md:flex items-center gap-3 lg:gap-4 ml-auto'>
            ...
            <Link
              ...
              className='bg-[#6A1B9A] hover:bg-[#4A1070] text-white font-semibold rounded-xl shadow-md px-3 lg:px-5 py-2 transition whitespace-nowrap'
            >
              Cloud Kitchen
            </Link>
            ...
            <ul className='space-y-5 text-lg font-medium text-gray-900 flex-1 overflow-y-auto pb-10'>
              {menu.map((item, i) => (
                ...
                >
                  <Link
                    ...
                    className='block px-5 py-4 rounded-2xl bg-white/85 hover:bg-white shadow border border-gray-200  justify-between items-center transition active:scale-[0.98]'
                  >
                    <span
                      className={
                        active === item.name
              ...
              >
                <Link
                  href='https://ghostkitchensindia.com/'
                  onClick={() => setMobileOpen(false)}
                  className='block py-4 rounded-2xl bg-[#6A1B9A] hover:bg-[#4A1070] text-white shadow font-semibold text-lg text-center'
                >
                  Cloud Kitchen
                </Link>
              </li>
